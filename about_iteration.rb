...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject is like reduce, it applies the operation along the array and keeps the result
    # to use as the next sum.
  end
  ...
  # It allows the File library to properly close the file handle to filename.
