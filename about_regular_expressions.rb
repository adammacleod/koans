...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  #
  # Why?
  # Because they match as many characters as possible. abbb instead of just ab for example
  ...
  def test_dollar_sign_anchors_to_the_end_of_lines
    assert_equal 42.inspect, "2 lines\nnum 42"[/\d+$/]
  end
  ...
  # A alternation matches entire sets of characters, not ANY character.
  ...
  def test_sub_is_like_find_and_replace
    ...
    # The block at the end is actually passed into sub, an alternate syntax could be sub(//, lambda {})
