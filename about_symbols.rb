...
class AboutSymbols < EdgeCase::Koan
  ...
  # Because referencing :test_method_names_become_symbols would create an entry for :test_method_names_become_symbols?
  ...
  # Symbols are created once and then stay in memory until the program terminates.
  # Creating a LOT of dynamic symbols would be a memory leak of sorts.
end
