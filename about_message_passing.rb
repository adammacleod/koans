...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Defining and using __send__ allows classes to define their own send method
    #   that might be more relevent than the object-level send implementation
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # Redefining method_missing would allow us to capture when a missing
    # method was called and handle the call in an appropriate manner.
    #
    # NOTE:
    #
